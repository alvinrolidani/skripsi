            ...
            <div class="card bg-primary">
                <div class="card-body">
                    ...
                    <div class="row justify-content-end">
                        <div class="col-8">
                            <div class="mt-4">
                                <img src="/templates/layouts/assets/images/widget-img.png" alt=""
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                <div>
                                    ...
                                    <div class="d-flex align-items-start mt-4">
                                        <div class="avatar-sm me-3">
                                            <img src="/templates/layouts/assets/images/users/avatar-4.jpg" alt=""
                    ...
                    <ul class="inbox-wid list-unstyled">
                            ...
                            <a href="#">
                                <div class="d-flex align-items-start">
                                    <div class="me-3 align-self-center">
                                        <img src="/templates/layouts/assets/images/users/avatar-3.jpg" alt=""
                        ...
                        <li class="inbox-list-item">
                            <a href="#">
                                <div class="d-flex align-items-start">
                                    <div class="me-3 align-self-center">
                                        <img src="/templates/layouts/assets/images/users/avatar-5.jpg" alt=""
                                            class="avatar-sm rounded-circle">
                                    </div>
                                    <div class="flex-1 overflow-hidden">
                        ...
                        <li class="inbox-list-item">
                            <a href="#">
                                <div class="d-flex align-items-start">
                                    <div class="me-3 align-self-center">
                                        <img src="/templates/layouts/assets/images/users/avatar-6.jpg" alt=""
                                            class="avatar-sm rounded-circle">
                                    </div>
                                    <div class="flex-1 overflow-hidden">
