        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <br>
                    <a href="{{ route('position.create') }}" class="btn btn-success">Tambah</a>
                    <br>
                    <br>
                    ...
                    <div class="table-rep-plugin">
                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                            <table id="tech-companies-1" class="table table-striped">
                                ...
                                <tbody>
                                    @foreach ($posisi as $key => $item)
                                        <tr>
                                            <th class="text-center">{{ $key + $posisi->firstItem() }}</th>
                                            <td class="text-center">{{ $item->nama_posisi }}</td>
                                            <td class="text-center">
                                                <a href="{{ route('position.show', $item->id) }}" class="btn">
                                                    <span class="mdi mdi-eye-outline" style="font-size:17px"></span>
                                                </a>
                                                <a href="{{ route('position.edit', $item->id) }}" class="btn">
                                                    <i class="mdi mdi-pencil-outline" style="font-size:17px"></i>
                                                </a>
                                                <a class="btn">
                                                    <i class="mdi mdi-delete-outline" data-bs-toggle="modal"
                                                        style="font-size:17px"
                                                        data-bs-target=".deleteposition{{ $item->id }}"></i>
                                                </a>
                                            </td>

                                        </tr>
                                        <div class="modal fade deleteposition{{ $item->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="/position/{{ $item->id }}/destroy"
                            ...
                            <div class="d-flex justify-content-start">
                                <p>Showing {{ $posisi->firstItem() }} to {{ $posisi->lastItem() }} of
                                    {{ $posisi->total() }}
                                </p>
                            </div>
